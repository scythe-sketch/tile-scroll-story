...
export const CoworkingSection = () => {
  return <section id="coworking" className="py-24 md:py-32 bg-secondary">
          ...
          <ScrollReveal direction="left">
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {features.map((feature, index) => <motion.div key={feature.label} whileHover={{
                scale: 1.05
