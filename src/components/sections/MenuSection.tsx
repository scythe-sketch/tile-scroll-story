          ...
          <AnimatePresence mode="wait">
            ...
            duration: 0.4
              ...
              <div className="mt-6 p-6 bg-card rounded-2xl">
                <p className="text-sm text-muted-foreground">Fresh ingredients. Honest flavours. Made to keep you going.<span className="font-medium text-primary">Cover charge:</span> ​
                </p>
              </div>
            </motion.div>
          </AnimatePresence>
